...
plaintexts = [x.decode("base64") for x in """
...
'''
Solved this the same way I solved 20. I don't get why
you would even try to go at this with substituion when
you have the power of reliable automation :D
'''
def challenge_19():
    global key
